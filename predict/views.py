...
def predict_chances(request):
    if request.POST.get('action')=='post':
        ...
        model_load=pd.read_pickle(r"D:\internship\Machine-Learning-with-Iris-Dataset-master\models.pickle")

        result=model_load.predict([[sepal_length,sepal_width,petal_length,petal_width]])  
